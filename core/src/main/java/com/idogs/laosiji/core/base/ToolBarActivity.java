 ...
 * @version 1.0.0 <br/>
 */
public abstract class ToolBarActivity<P extends BasePresenter> extends BaseActivity<P> implements BaseView {

    public static final int TOOL_BAR_LAYOUT = R.layout.fragment_title;
